...
Wrong answers are generated within a range of ±5 from the correct answer, making them plausible while still being distinguishable. The options are shuffled using the Fisher-Yates algorithm for unbiased randomization.
